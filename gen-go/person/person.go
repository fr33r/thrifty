...
var _ = address.GoUnusedProtection__
...
type Person struct {
  ...
  Address *address.Address `thrift:"address,4" db:"address" json:"address"`
}
...
var Person_Address_DEFAULT *address.Address
func (p *Person) GetAddress() *address.Address {
  if !p.IsSetAddress() {
